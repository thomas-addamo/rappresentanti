  ...
  return (
    ...
    >
      <div className="min-h-screen relative">
        {/* Header / Navigation */}
        <div className="sticky top-0 left-0 w-full p-6 md:p-12 flex justify-between items-center bg-paper/90 backdrop-blur-sm z-50 border-b border-primary/5">
            <button 
                onClick={onBack}
                className="group flex items-center gap-3 font-sans uppercase tracking-widest text-sm text-primary hover:opacity-60 transition-opacity"
            >
                <div className="p-2 border border-primary rounded-full group-hover:bg-primary group-hover:text-paper transition-colors">
                    <ArrowLeft size={20} />
                </div>
                Torna Indietro
            </button>
            <div className="hidden md:block font-serif italic text-xl">Rappresentanti. News</div>
        </div>
